...
Documented platform/docs bugs: [`BUG_REPORTS.md`](../BUG_REPORTS.md)

> **Addendum (2026-09-17):** Repo version labels are now **0.1.5** (synced by
> commit 98f91cc). The live registry lists contract **id 1029 @ 0.1.5** —
> status **pending-live-verify** as of 2026-09-17; the end-to-end
> re-verification run has not happened yet. All **0.1.3 / id-1025** claims
> below are dated 2026-09-15 facts and are kept as history, not rewritten.
> See also [`docs/SUBMISSION_STATUS.md`](./SUBMISSION_STATUS.md).
